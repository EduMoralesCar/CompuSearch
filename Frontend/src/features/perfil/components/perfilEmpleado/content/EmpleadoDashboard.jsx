...
const EmpleadoDashboard = () => {
    ...
    return (
        <Container fluid className="py-4" style={{ backgroundColor: "#f8f9fa", minHeight: "100vh" }}>
            ...
            <Row className="mb-4">
                <Col>
                    <h2 className="fw-bold text-primary mb-1">Dashboard del Empleado</h2>
                    <p className="text-muted mb-0">Consulta las métricas del sistema y revisa la actividad reciente.</p>
                </Col>
            </Row>
